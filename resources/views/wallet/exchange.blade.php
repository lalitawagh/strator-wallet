                                    ...
                                    <div class="intro-y  overflow-x-auto overflow-y-hidden  mt-3 sm:mt-0">
                                        ...
                                        <div class="sm:flex items-center p-2 sm:py-0 border-b border-gray-200 dark:border-dark-5">
                                            ...
                                            <div class="dark:text-gray-300">1 of 50</div>
                                                ...
                                                <a href="{{ route('design.email-template') }}" class="w-5 h-5 mr-2 flex items-center justify-center dark:text-gray-300"> <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="#c1c4c9">
                                                                ...
                                                                <div class="absolute top-0 mt-2 dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu w-40">
                                                                        <div class="dropdown-menu__content box p-2">
                                                                            ...
                                                                            <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="eye" class="w-4 h-4 mr-1"></i> View </a>
