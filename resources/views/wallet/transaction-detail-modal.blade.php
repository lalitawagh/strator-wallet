    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header p-5">
                ...
                <a id="transactionDetailsSave"
                    class="save-transaction cursor-pointer hidden intro-x w-8 h-8 flex items-center justify-center rounded-full bg-theme-14 text-theme-10 ml-2 tooltip"
                    title="Save"> <i data-lucide="save" class="w-30 h-30"></i> </a>
                <a id="transactionDetailsClose"
