        ...
        <div class="col-span-12 xxl:col-span-12">
            ...
            <div class="grid grid-cols-12 gap-3">
                <div class="col-span-12 md:col-span-8 lg:col-span-8 mt-3">
                    <div
                        class="intro-y shadow-lg p-3 rounded-2xl bg-white p-5  h-full dark:bg-darkmode-400 dark:border-darkmode-400">
                ...
                <div
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{ route('dashboard.wallet.transaction.index', ['filter' => ['workspace_id' => $workspace?->getKey()]]) }}"
