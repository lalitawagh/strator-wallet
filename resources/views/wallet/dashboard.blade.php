            ...
            <div class="grid grid-cols-12 gap-3">
                ...
                <div class="shadow-lg p-3 rounded-2xl bg-white col-span-12 md:col-span-4 lg:col-span-4 mt-3">
                    <div class="mt-2">
                        ...
                        <a href="{{ route('dashboard.wallet.transaction.index')}}" class="intro-x w-full block text-center rounded-md py-3 border border-dotted border-theme-15 dark:border-dark-5 text-theme-16 dark:text-gray-600">View More</a>
                    </div>
                </div>
            </div>
