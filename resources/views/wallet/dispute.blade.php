            ...
            <div class="intro-y box p-5 mt-0">
                <div class="mt-1">
                    <div class="flex pr-0 border-b border-gray-200 dark:border-dark-5 pb-2 mt-0">
                        ...
                        <div class="text-gray-600 text-xs whitespace-nowrap"> <span class="event__days">TIC-FOPCTM</span>
                        </div>
                    </div>
                    <div class="flex pr-0 border-b border-gray-200 dark:border-dark-5 pb-2 mt-2">
                        ...
                        <div class="text-gray-600 text-xs whitespace-nowrap"> <span class="event__days">New Tickets</span>
                        </div>
                    </div>
                    <div class="flex pr-0 border-b border-gray-200 dark:border-dark-5 pb-2 mt-2">
                        <div class="font-medium whitespace-nowrap mr-auto">Date </div>
                        <div class="text-gray-600 text-xs whitespace-nowrap"> <span class="event__days">22-10-2021 4:00
                                AM</span></div>
                    </div>
                    <div class="flex pr-0 border-b border-gray-200 dark:border-dark-5 pb-2 mt-2">
                    ...
                    <div class="flex pr-0 mt-2">
                        ...
                        <div class="text-gray-600 text-xs whitespace-nowrap">
                            <div
                                class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium w-16">
                                Success</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
                ...
                <div class="intro-x cursor-pointer relative flex items-center p-0">
                    <div class="box border-b border-gray-200 dark:border-dark-5 pb-2">
                        <div
                            class="clearfix flex-col items-start px-5 pt-5 border-b border-gray-200 dark:border-dark-5 pb-2 mx-5">
                            <form>
                                <div class="w-full">
                                    ...
                                    <div class="md:flex mt-2">
                                        ...
                                        <div class="form-inline">
                                            ...
                                            <input id="bic_swift_code" name="bic_swift_code" type="file"
                                                class="form-control w-full " placeholder="BIC Swift Code">
                                            <span class="text-theme-6 block mt-2"></span>
                                        </div>

                                    </div>
                                    <div class="col-span-12 float-right">
                                        <button id="DisputeSubmit"
                                            class="btn btn-sm btn-primary w-24 mr-1 mt-2 mb-2 text-right">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div class="sm:flex col-span-12 lg:col-span-12 xxl:col-span-12">
            <h2 class="sm:flex intro-y text-lg font-medium mt-2 w-full">
                ...
                <div class="sm:flex text-gray-600 text-xs mt-0.5 ml-auto">
                    <span
                        class="event__days py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium mr-2">Priority:
                        Normal</span>
                    <span
                        class="event__days py-1 px-2 rounded-full text-xs bg-theme-1 text-white cursor-pointer font-medium">Assignee:
                        Admin Techvill</span>
                </div>
            </h2>
        </div>
                        ...
                        <div
                            ...
                            <form>
                                            ...
                                            <div class="form w-full ml-0">
                                                <div class="p-0" id="standard-editor">
                                                    ...
                                                    <div class="source-code hidden">
                                                        <button data-tw-target="#copy-standard-editor"
                                                            class="copy-code btn py-1 px-2 btn-outline-secondary"> <i
                                                                data-lucide="file" class="w-4 h-4 mr-2"></i> Copy example
                                                            code </button>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="col-span-12 float-right">
                                        <button id="DisputeReply"
                                            class="btn btn-sm btn-primary w-24 mr-1 mt-2 mb-2 text-right">Reply</button>
                                    </div>
                                </div>
                            </form>
                        </div>
