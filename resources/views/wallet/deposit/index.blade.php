...
@section('title', 'Wallet Deposit List')
                ...
                <div class="intro-y mt-3 sm:mt-3">
                    <div class="sm:flex items-center p-2 sm:py-0 border-b border-gray-200 dark:border-dark-5">
                        ...
                        <div class="flex items-center p-3 border-b border-gray-200 dark:border-dark-5" style="margin-top:-6px;">
                            ...
                            <div>
                                <a href="{{ route('dashboard.ledger-foundation.wallet.deposit-initial',['workspace_id' => $workspace->id]) }}" class="btn btn-sm btn-primary shadow-md btn btn-sm btn-primary ml-2">Deposit</a>
                            </div>
                            @endif
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header p-5">
                    <h2 class="font-medium text-base mr-auto">Deposit Details</h2>
