    ...
    @csrf
        ...
        <div class="px-5 sm:px-5 mt-0 pt-0">
            ...
            <div class="flex">
                ...
                <div class="font-medium">@isset ($details) {{ \Kanexy\PartnerFoundation\Core\Helper::getFormatAmountWithCurrency($details['amount'], $details['currency']); }} @endisset</div>
            </div>
            <div class="flex mt-4">
                <div class="mr-auto">Fee</div>
                <div class="font-medium">@isset ($details) {{ \Kanexy\PartnerFoundation\Core\Helper::getFormatAmountWithCurrency($details['fee'], $details['currency']); }} @endisset</div>
            </div>
            ...
            <div class="text-right mt-5 form-inline text-right mt-5 float-right">
                <a href="{{ route('dashboard.wallet.deposit.create',['worksapce_id' => @$details['workspace_id']]) }}" class="btn btn-secondary w-20 inline-block mr-2">Previous</a>
