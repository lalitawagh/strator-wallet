            ...
            <div class="intro-y box col-span-12 xxl:col-span-12">
                <div
                    ...
                    <div class="breadcrumb mr-auto hidden sm:flex">
                        ...
                        <a id="EditCommodity" href="" class="breadcrumb--active"> Edit Commodity Type</a>
                    </div>
                </div>
                <div class="p-5">
                    <form action="{{ route('dashboard.wallet.commodity-type.update', $commodity_type['id']) }}"
                            ...
                            <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    ...
                                    <img class="rounded-md proof-default" style="width:100px;" alt=""
                                        src="@isset($commodity_type['image']) {{ \Illuminate\Support\Facades\Storage::disk('azure')->temporaryUrl($commodity_type['image'], now()->addMinutes(5)) }} @endisset">
                                    @error('image')
                                        <span class="block text-theme-6 mt-2">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6 form-check form-switch">
                                    <input id="status" name="status" type="checkbox" class="form-check-input"
                                        @if (old('status', $commodity_type['status']) === \Kanexy\LedgerFoundation\Enums\WalletStatus::ACTIVE) checked @endif>
                        ...
                        <div class="text-right mt-5">
                            <a id="commodityTypeEditCancel" href="{{ route('dashboard.wallet.commodity-type.index') }}"
                                class="btn btn-secondary w-24 inline-block mr-1">Cancel</a>
                            <button id="commodityTypeEditUpdate" type="submit" class="btn btn-primary w-24">Update</button>
                        </div>
                    </form>
                </div>
            </div>
