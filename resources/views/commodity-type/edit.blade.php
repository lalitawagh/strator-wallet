                        ...
                        <div class="grid grid-cols-12 lg:gap-10 mt-0">
                            ...
                            <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    ...
                                    <img class="rounded-md proof-default" style="width:100px;" alt="" src="@isset($commodity_type['image']){{ \Illuminate\Support\Facades\Storage::temporaryUrl($commodity_type['image'],now()->addMinutes(5))  }}@endisset">
                                    @error('image')
                                    <span class="block text-theme-6 mt-2">{{ $message }}</span>
                                    @enderror
                                </div>
