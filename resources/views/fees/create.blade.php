        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="intro-y box col-span-12 xxl:col-span-12">
                ...
                <div class="p-5">
                    ...
                    @endif
                    <form action="{{ route('dashboard.wallet.fee.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6 tillselect-marging">
                                    <select class="form-control" data-search="true" name="payment_type">
                                        <option value="deposit" @if (old('payment_type') == 'deposit') selected @endif>Deposit
                                        </option>
                                        <option value="payout" @if (old('payment_type') == 'payout') selected @endif>Payout
                                        </option>
                                        <option value="withdraw" @if (old('payment_type') == 'withdraw') selected @endif>Withdraw
                                        </option>
                                    </select>
                        ...
                        <div class="text-right mt-5">
                            <a id="feeSetupCreateCancel" href="{{ route('dashboard.wallet.fee.index') }}"
                                class="btn btn-secondary w-24 inline-block mr-1">Cancel</a>
                            <button id="feeSetupCreate" type="submit" class="btn btn-primary w-24">Create</button>
                        </div>
                    </form>
                </div>
            </div>
