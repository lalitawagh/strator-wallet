            ...
            <table id="tableID" class="shroting display table table-report mt-2" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="whitespace-nowrap text-left">{{$wallet_urn}}</td>
                        <td class="whitespace-nowrap text-left">28 Aug 2021</td>
                        <td class="whitespace-nowrap text-left">Pay Coin</td>
                        <td class="whitespace-nowrap text-left">Recieve Pay coin</td>
                        <td class="whitespace-nowrap text-left">Success</td>
                        <td class="whitespace-nowrap text-left">30</td>
                        <td class="whitespace-nowrap text-left">-20</td>
                        <td class="whitespace-nowrap text-left">Recieve Pay coin</td>
                        <td class="whitespace-nowrap text-left">-20</td>
                        <td class="table-report__action">
                            <div class="absolute top-0 mt-2 dropdown">
