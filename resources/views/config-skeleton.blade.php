            ...
            <div class="intro-y box mt-5 lg:mt-0"  x-data="toggleConfigurationSidebarMenu()">
                <div class="relative flex items-center p-5">
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex">
                        <a href="">Wallets</a><svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right breadcrumb__icon breadcrumb__icon"><polyline points="9 18 15 12 9 6"></polyline></svg>
                ...
                <div class="side-nav p-5 border-t border-gray-200 dark:border-dark-5">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('dashboard.ledger-foundation.ledger.index') }}" class="side-menu @if(Route::current()->getName() == 'dashboard.ledger-foundation.ledger.index' || Route::current()->getName() ==  'dashboard.ledger-foundation.ledger.create' || Route::current()->getName() == 'dashboard.ledger-foundation.ledger.edit') side-menu--active @endif">
                                <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                        ...
                        <li>
                            <a href="javascript:;.html" class="side-menu
                                @if(Route::current()->getName() == 'dashboard.ledger-foundation.asset-type.index' ||
                                    Route::current()->getName() ==  'dashboard.ledger-foundation.asset-type.create' ||
                                    Route::current()->getName() ==  'dashboard.ledger-foundation.asset-type.edit' ||
                                    Route::current()->getName() ==  'dashboard.ledger-foundation.asset-class.index' ||
                                    Route::current()->getName() ==  'dashboard.ledger-foundation.asset-class.create' ||
                                    Route::current()->getName() ==  'dashboard.ledger-foundation.asset-class.edit' ||
                                    Route::current()->getName() ==  'dashboard.ledger-foundation.commodity-type.index' ||
                                    Route::current()->getName() ==  'dashboard.ledger-foundation.commodity-type.create'||
                                    Route::current()->getName() ==  'dashboard.ledger-foundation.commodity-type.edit')
                            ...
                            @endif
                                <li>
                                    <a href="{{ route("dashboard.ledger-foundation.asset-type.index") }}" class="side-menu  @if(Route::current()->getName() ==  'dashboard.ledger-foundation.asset-type.index' ||
                                        Route::current()->getName() ==  'dashboard.ledger-foundation.asset-type.create' ||
                                        Route::current()->getName() ==  'dashboard.ledger-foundation.asset-type.edit')
                                ...
                                <li>
                                    <a href="{{ route('dashboard.ledger-foundation.asset-class.index') }}" class="side-menu
                                    @if(Route::current()->getName() ==  'dashboard.ledger-foundation.asset-class.index' ||
                                        Route::current()->getName() ==  'dashboard.ledger-foundation.asset-class.create' ||
                                        Route::current()->getName() ==  'dashboard.ledger-foundation.asset-class.edit')
                                         side-menu--active @endif">
                                        <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                ...
                                <li>
                                    <a href="{{ route('dashboard.ledger-foundation.commodity-type.index') }}" class="side-menu @if( Route::current()->getName() ==  'dashboard.ledger-foundation.commodity-type.index' ||
                                        Route::current()->getName() ==  'dashboard.ledger-foundation.commodity-type.create'||
                                        Route::current()->getName() ==  'dashboard.ledger-foundation.commodity-type.edit')  side-menu--active @endif">
                                        <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
