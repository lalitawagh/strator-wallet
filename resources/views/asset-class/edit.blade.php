    ...
    <div class="configuration-container w-screen">
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="intro-y box col-span-12 xxl:col-span-12">
                <div class="gap-2 sm:gap-0 flex flex-wrap items-center px-5 py-5 sm:py-3 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <form action="{{ route('dashboard.wallet.asset-class.update',$asset_class['id']) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-12 md:gap-0 lg:gap-3 xl:gap-10 mt-0">
                            ...
                            <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    ...
                                    <img class="rounded-md proof-default pt-2" style="width:100px;" alt="" src="{{ \Illuminate\Support\Facades\Storage::temporaryUrl($asset_class['image'],now()->addMinutes(5))  }}">
                                    @endisset
                        ...
                        <div class="grid grid-cols-12 md:gap-0 lg:gap-3 xl:gap-10 mt-0">
                            <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    <input id="status" name="status" type="checkbox" class="form-check-switch" @if ($asset_class['status'] == \Kanexy\LedgerFoundation\Enums\WalletStatus::ACTIVE) checked @endif>
