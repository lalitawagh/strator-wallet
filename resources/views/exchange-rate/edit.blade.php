        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="intro-y box col-span-12 xxl:col-span-12">
                ...
                <div class="p-5">
                    ...
                    @endif
                    <form action="{{ route('dashboard.wallet.exchange-rate.update', $exchange_rate->getKey()) }}"
                                    ...
                                    <select name="exchange_currency" id="exchange_currency" class="form-control"
                                        ...
                                        @foreach ($asset_types as $asset_type)
                                            <option value="{{ $asset_type['id'] }}"
                                                @if ($exchange_rate->exchange_currency == $asset_type['id']) selected @endif>
                            ...
                            <div class="col-span-12 md:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    <input id="exchange_rate" name="exchange_rate" type="text"
                                        ...
                                        value="{{ old('exchange_rate', $exchange_rate->exchange_rate) }}"
                                        onKeyPress="return isNumberKey(event);" required>
                        ...
                        <div class="grid grid-cols-12 md:gap-3 mt-0">
                            ...
                            <div
                                class="col-span-12 md:col-span-6 form-inline mt-2 @if (!is_null(old('is_hard_stop'))) @elseif($exchange_rate->is_hard_stop === 0) valid_date hidden @endif">
