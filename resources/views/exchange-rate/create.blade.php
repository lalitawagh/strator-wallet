                ...
                <div class="p-5">
                    ...
                    <form action="{{ route('dashboard.wallet.exchange-rate.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    <input id="exchange_fee" name="exchange_fee" type="text"
                                        ...
                                        value="{{ old('exchange_fee') }}" onKeyPress="return isNumberKey(event);" required>
                            ...
                            <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    <input id="exchange_rate" name="exchange_rate" type="text"
                                        ...
                                        value="{{ old('exchange_rate') }}"  onKeyPress="return isNumberKey(event);" required>
                        ...
                        <div class="grid grid-cols-12 md:gap-3 mt-0">
                            ...
                            <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2 @if(!is_null(old('is_hard_stop'))) @else valid_date hidden @endif">
