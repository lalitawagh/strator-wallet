            ...
            <div class="box">
                ...
                <div class="p-5">
                    <form action="{{ route('dashboard.banking.beneficiaries.update', $beneficiary->id) }}" method="POST"
                            ...
                            <div class="col-span-12 md:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    <div class="flex sm:flex-col sm:flex-row mt-0">
                                        ...
                                        <div class="form-check mr-2 mt-0 sm:mt-0">
                                            <input id="type-company" class="form-check-input contact-type" type="radio"
                                                name="type" value="company"
                                                @if (old('type', $beneficiary->type) == 'company' || old('type') == 'company') checked @endif>
                        ...
                        <div class="grid grid-cols-12 md:gap-0 lg:gap-3 xl:gap-8 mt-0 contact-personal">
                            <div class="col-span-12 md:col-span-6 form-inline mt-2">
                            ...
                            <div class="col-span-12 md:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    <input id="landline" name="landline" type="text"
                                        ...
                                        value="{{ old('landline', $beneficiary->landline) }}">
                            ...
                            <div class="col-span-12 md:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    <input id="bank_account_name" name="meta[bank_account_name]" type="text"
                                        ...
                                        value="{{ old('meta.bank_account_name', $beneficiary->meta['bank_account_name']) }}"
                                        required disabled>
                            ...
                            <div class="col-span-12 md:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    <input id="bank_account_number" name="meta[bank_account_number]" type="text"
                                        ...
                                        value="{{ old('meta.bank_account_number', @$beneficiary->meta['bank_account_number']) }}"
                                        required disabled>
