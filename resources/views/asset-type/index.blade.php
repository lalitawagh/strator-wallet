                                ...
                                @foreach ($asset_type_lists as $index => $asset_type_list)
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap text-left">
                                            ...
                                            <img class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden rounded-md proof-default" src="{{ \Kanexy\PartnerFoundation\Core\Helper::getTemporaryUrl($asset_type_list['image']) }}">
                                            @endisset
                                        </td>
