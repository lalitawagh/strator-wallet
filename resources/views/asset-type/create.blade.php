            ...
            <div class="intro-y box col-span-12 xxl:col-span-12">
                <div
                    ...
                    <div class="breadcrumb mr-auto sm:flex justify-around">
                        ...
                        <a id="CreateAsset" href="" class="breadcrumb--active">Create Asset Type</a>
                    </div>
                </div>
                <div class="p-5">
                    <form action="{{ route('dashboard.wallet.asset-type.store') }}" method="POST"
                                    ...
                                    <select name="asset_category" id="asset_category" data-search="true"
                                        ...
                                        @foreach ($asset_categories as $key => $asset_category)
                                            <option value="{{ $asset_category }}"
                                                @if (old('asset_category') == $asset_category) selected @endif>
                        ...
                        <div class="text-right mt-5">
                            <a id="assetTypeCancel" href="{{ route('dashboard.wallet.asset-type.index') }}"
                                class="btn btn-secondary w-24 inline-block mr-1">Cancel</a>
                            <button id="assetTypeCreate" type="submit" class="btn btn-primary w-24">Create</button>
                        </div>
                    </form>
                </div>
            </div>
