    ...
    <div class="configuration-container w-screen">
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="intro-y box col-span-12 xxl:col-span-12">
                ...
                <div class="p-5">
                    <form action="{{ route('dashboard.wallet.asset-type.update', $asset_type['id']) }}" method="POST"
                        ...
                        <div class="grid grid-cols-12 md:gap-0 lg:gap-3 xl:gap-10 mt-0">
                            <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6 tillselect-marging">
                                    ...
                                    @endphp
                                    <select name="asset_category" id="asset_category" data-search="true"
                                        class="tom-select w-full @error('asset_category') border-theme-6 @enderror">
                                        @foreach ($asset_categories as $key => $asset_category)
                                            <option value="{{ $asset_category }}"
                                                @if (old('asset_category', $asset_type['asset_category']) == $asset_category) selected @endif>
                                ...
                                <div class="sm:w-5/6">
                                    ...
                                    @isset($asset_type['image'])
                                        <img class="rounded-md proof-default pt-2" style="width:100px;" alt=""
                                            src="{{ \Illuminate\Support\Facades\Storage::disk('azure')->temporaryUrl($asset_type['image'], now()->addMinutes(5)) }}">
                                    @endisset
                            ...
                            <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6 form-check form-switch">
                                    <input id="status" name="status" type="checkbox" class="form-check-input"
                                        @if (old('status', $asset_type['status']) === \Kanexy\LedgerFoundation\Enums\WalletStatus::ACTIVE) checked @endif>
