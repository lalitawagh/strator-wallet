                    ...
                    <form action="{{ route('dashboard.wallet.master-account.store') }}" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="grid grid-cols-12 md:gap-3 mt-0">
                            <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    <select name="country" id="country"  x-model="location" data-search="true" class="tail-select w-full @error('country') border-theme-6 @enderror" required>
                            ...
                            <div class="col-span-12 md:col-span-6 form-inline mt-2">
                                <label for="status" class="form-label sm:w-60"> Status </label>
                                <div class="sm:w-5/6">
                        ...
                        <div class="grid grid-cols-12 md:gap-3 mt-0">
                            ...
                            <div   class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    <input id="ifsc_code" name="ifsc_code" type="text" class="form-control @error('ifsc_code') border-theme-6 @enderror" value="{{ old('ifsc_code',@$account_details['ifsc_code']) }}" required>
