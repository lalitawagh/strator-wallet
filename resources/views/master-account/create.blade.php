                ...
                <div class="p-5">
                    <form action="{{ route('dashboard.wallet.master-account.store') }}" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="grid grid-cols-12 md:gap-3 mt-0">
                            ...
                            <div id="sort_code"  class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                            ...
                            <div id="ifsc_code" class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2" style="display: none;">
