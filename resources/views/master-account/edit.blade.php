            ...
            <div class="intro-y box col-span-12 xxl:col-span-12">
                <div
                    ...
                    <div class="breadcrumb mr-auto hidden sm:flex">
                        ...
                        <a id="EditMasterAccount" href="" class="breadcrumb--active"> Edit Master Account</a>
                    </div>
                </div>
                <div class="p-5">
                    <form action="{{ route('dashboard.wallet.master-account.update', $master_account['id']) }}"
                                    ...
                                    <select name="country" id="country" onchange="getCountry(this)" data-search="true"
                                        ...
                                        @foreach ($countries as $country)
                                            <option value="{{ $country->id }}"
                                                @if (old('country', $master_account['country']) == $country->id) selected @endif> {{ $country->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-span-12 md:col-span-8 lg:col-span-6 sm:col-span-8 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    <input id="account_holder_name" name="account_holder_name" type="text"
                                        ...
                                        value="{{ old('account_holder_name', $master_account['account_holder_name']) }}"
                                        required>
                        ...
                        <div class="text-right mt-5">
                            <a id="masterAccountsEditCancel" href="{{ route('dashboard.wallet.master-account.index') }}"
                                class="btn btn-secondary w-24 inline-block mr-1">Cancel</a>
                            <button id="masterAccountsUpdate" type="submit" class="btn btn-primary w-24">Update</button>
                        </div>
                    </form>
                </div>
            </div>
