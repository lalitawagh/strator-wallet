                            ...
                            <div class="col-span-12 md:col-span-6 form-inline mt-2">
                                ...
                                <div class="sm:w-5/6">
                                    <select name="status" id="status" data-search="true" class="tail-select w-full">
                                        ...
                                        <option value="{{ \Kanexy\LedgerFoundation\Enums\LedgerStatus::SUSPENDED }}" @if (old("suspended",$ledger->status)  === \Kanexy\LedgerFoundation\Enums\LedgerStatus::SUSPENDED) selected @endif>{{ trans('ledger-foundation::configuration.suspended') }}</option>
                                    </select>
                                    @error('status')
                                    <span class="block text-theme-6 mt-2">{{ $message }}</span>
                                    @enderror
