...
class CommodityTypeController extends Controller
{
    ...
    {
        $this->authorize(CommodityTypePolicy::VIEW, LedgerConfiguration::class);
    ...
    {
        $this->authorize(CommodityTypePolicy::CREATE, LedgerConfiguration::class);
    ...
    {
        $this->authorize(CommodityTypePolicy::EDIT, LedgerConfiguration::class);
    ...
    {
        $this->authorize(CommodityTypePolicy::DELETE, LedgerConfiguration::class);
